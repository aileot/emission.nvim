...
default_config = {debug = debug_config, attach = {delay = 100, excluded_filetypes = {}, excluded_buftypes = {"help", "nofile", "terminal", "prompt"}}, highlight_delay = 10, highlight = {duration = 300, filter = _3_}, added = {priority = 102, hl_map = {default = true, bold = true, fg = "#dcd7ba", bg = "#2d4f67"}, filter = _4_}, removed = {priority = 101, hl_map = {default = true, bold = true, fg = "#dcd7ba", bg = "#672d2d"}, filter = _5_}}
local cache = {config = vim.deepcopy(default_config), namespace = vim.api.nvim_create_namespace("emission"), timer = uv.new_timer(), ["pending-highlights"] = Stack.new(), ["hl-group"] = {added = "EmissionAdded", removed = "EmissionRemoved"}, ["last-editing-position"] = {0, 0}, ["buf->detach?"] = {}, ["last-recache-time"] = 0, ["buf->old-texts"] = {}}
...
local function dismiss_deprecated_highlight_21(buf, _7_)
  local start_row0 = _7_[1]
  local start_col0 = _7_[2]
  do
    local _8_ = cache["last-editing-position"]
    if ((_G.type(_8_) == "table") and (_8_[1] == start_row0) and (_8_[2] == start_col0)) then
...
local function dismiss_deprecated_highlights_21(buf, _10_)
  local start_row0 = _10_[1]
  local start_col0 = _10_[2]
...
local function request_to_clear_highlights_21(buf)
  ...
  return cache.timer:start(duration, 0, _13_)
end
...
local function highlight_added_texts_21(buf, _17_, _18_)
  local start_row0 = _17_[1]
  local start_col0 = _17_[2]
  local new_end_row_offset = _18_[1]
  local new_end_col_offset = _18_[2]
...
local function highlight_removed_texts_21(buf, _22_, _23_)
  local start_row0 = _22_[1]
  local start_col0 = _22_[2]
  local old_end_row_offset = _23_[1]
  local old_end_col_offset = _23_[2]
  ...
  first_removed_line = string.sub(old_texts[start_row], inc(start_col0), _25_())
